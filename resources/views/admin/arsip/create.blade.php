<x-app-layout>
    ...
    <div class="mb-6 border-b border-gray-100 pb-4">
        <h2 class="text-2xl font-bold text-gray-900">Upload Arsip Utama</h2>
        <p class="text-sm text-gray-500 mt-1">Unggah dokumen secara langsung ke dalam Sistem Arsip Utama (tanpa melalui proses verifikasi).</p>
    </div>
    ...
    <div class="max-w-4xl mx-auto bg-white rounded-xl border border-gray-200 shadow-sm p-8 mt-6">
        <div class="mb-6 border-b border-gray-100 pb-4">
            <h3 class="text-xl font-bold text-gray-900 flex items-center">
                ...
                Form Pengarsipan Langsung (Admin)
            </h3>
            <p class="text-sm text-gray-500 mt-1">Pilih kategori yang sesuai. Dokumen yang diunggah akan langsung berstatus sah/disetujui.</p>
        </div>
        ...
        <form action="{{ route('admin.arsip.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="judul_dokumen" value="{{ old('judul_dokumen') }}" required placeholder="Contoh: SK Pengangkatan 2024..." class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:bg-white focus:ring-2 focus:ring-primary-light focus:border-primary outline-none transition">
                </div>

                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Kategori <span class="text-red-500">*</span></label>
                    <select name="kategori_id" required class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:bg-white focus:ring-2 focus:ring-primary-light focus:border-primary outline-none transition cursor-pointer text-gray-700">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Lokasi Arsip Fisik / Folder <span class="text-gray-400 font-normal">(Opsional)</span></label>
                    <input type="text" name="lokasi_arsip" value="{{ old('lokasi_arsip') }}" placeholder="Contoh: Lemari A, Rak 2 / Arsip Digital Pusat" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:bg-white focus:ring-2 focus:ring-primary-light focus:border-primary outline-none transition">
                </div>
                ...
                <div>
                    ...
                    <textarea name="keterangan" rows="1" placeholder="Berikan catatan arsip..." class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:bg-white focus:ring-2 focus:ring-primary-light focus:border-primary outline-none transition">{{ old('keterangan') }}</textarea>
                </div>
            </div>

            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">Upload File Dokumen <span class="text-red-500">*</span></label>
                ...
                <label for="file_upload" id="drop_area" class="mt-1 flex flex-col items-center justify-center px-6 pt-8 pb-8 border-2 border-gray-300 border-dashed rounded-xl bg-gray-50 hover:bg-gray-100 hover:border-primary transition cursor-pointer group">
                    ...
                    <div id="file_success" class="hidden text-center">
                        ...
                        <p class="text-xs text-green-600 mt-1">File siap diarsipkan. Klik lagi jika ingin mengganti.</p>
                    </div>
                </label>
